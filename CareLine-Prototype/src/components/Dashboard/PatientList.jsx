...
export default function PatientList({ commonWaitList, urgentWaitList, patients, onViewDetails }) {
    return (
        <div className="bg-white p-6 rounded shadow-md">
            <h3 className="text-xl font-semibold mb-2">Urgent List ({urgentWaitList.length})</h3>
            <ul>
            ...
            <h3 className="text-xl font-semibold mt-4 mb-2">Common List ({commonWaitList.length})</h3>
            <ul>
